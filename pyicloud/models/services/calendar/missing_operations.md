...
PATH PARAMS:
    - #TODO: determine path params for update_calendar
QUERY PARAMS:
    - #TODO: determine query params for update_calendar
...
PATH PARAMS:
    - #TODO: determine path params for update_event
QUERY PARAMS:
    - #TODO: determine query params for update_event
...
PATH PARAMS:
    - #TODO: determine path params for idle
QUERY PARAMS:
    - #TODO: determine query params for idle
...
PATH PARAMS:
    - #TODO: determine path params for alarmtriggers
QUERY PARAMS:
    - #TODO: determine query params for alarmtriggers
...
PATH PARAMS:
    - #TODO: determine path params for State
QUERY PARAMS:
    - #TODO: determine query params for State
...
PATH PARAMS:
    - #TODO: determine path params for serverpreferences
QUERY PARAMS:
    - #TODO: determine query params for serverpreferences
...
METHOD: POST
URL: {service_root}/ca/events/{event.pguid}/{event.guid}__20250802T100000Z/all
PATH PARAMS:
    - #TODO: determine path params for remove all events from a recurring event
QUERY PARAMS:
    - #TODO: determine query params for remove all events from a recurring event
...
PATH PARAMS:
    - #TODO: determine path params for attachment
QUERY PARAMS:
    - #TODO: determine query params for attachment
    - example:
[
