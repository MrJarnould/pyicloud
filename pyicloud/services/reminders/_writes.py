...
class RemindersWriteAPI:
        ...
        *,
        ...
        child_op = CKModifyOperation(
            ...
            record=self._write_record(
                ...
                record_type=record_type,
                fields=child_fields,
                parent_record_name=reminder.id,
            ),
        )
        ...
        _refresh_record_change_tag(modify_response, reminder, reminder.id)
        ...
        alarm_op = CKModifyOperation(
            ...
            record=self._write_record(
                ...
                fields={
                    ...
                    "Reminder": {
                        "type": "REFERENCE",
                        "value": {"recordName": reminder.id, "action": "VALIDATE"},
                    },
        ...
        trigger_op = CKModifyOperation(
            ...
            record=self._write_record(
                ...
                fields={
                    ...
                    "Proximity": {"value": int(proximity), "type": "INT64"},
                    "Radius": {"value": radius, "type": "DOUBLE"},
                    "ReferenceFrameString": {
                        "value": "1",
                        "isEncrypted": True,
                        "type": "STRING",
                    },
                    "Title": {"value": title, "isEncrypted": True, "type": "STRING"},
    ...
    def update_hashtag(self, hashtag: Hashtag, name: str) -> None:
        ...
        if hashtag.reminder_id:
            fields["Reminder"] = {
                "type": "REFERENCE",
                "value": {"recordName": hashtag.reminder_id, "action": "VALIDATE"},
            }
    ...
    def update_attachment(
        ...
        *,
        ...
        if attachment.reminder_id:
            fields["Reminder"] = {
                "type": "REFERENCE",
                "value": {"recordName": attachment.reminder_id, "action": "VALIDATE"},
            }
        ...
        *,
        ...
        recurrence_record_name, modify_response = self._create_linked_child(
            ...
            child_fields={
                ...
                "Frequency": {"type": "INT64", "value": int(frequency)},
                "Interval": {"type": "INT64", "value": int(interval)},
                "OccurrenceCount": {"type": "INT64", "value": int(occurrence_count)},
                "FirstDayOfTheWeek": {
                    "type": "INT64",
        ...
        *,
        ...
        if recurrence_rule.reminder_id:
            fields["Reminder"] = {
                "type": "REFERENCE",
                "value": {
                    "recordName": recurrence_rule.reminder_id,
                    "action": "VALIDATE",
                },
            }
